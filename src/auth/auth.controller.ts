...
export class AuthController {
	...
	verify(data: { accessToken: string; roles: RolesTypeEnum[] }): string | JwtPayload | object {
	...
	async refreshToken(data: {
		...
		const refreshToken: RefreshTokensEntity = await this._refreshTokenService.get(data.refreshToken);
